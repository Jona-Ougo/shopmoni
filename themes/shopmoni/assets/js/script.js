(function($){
    ...
    ***  Auto width megamenu
    ...
    $(document).ready(function() {
        ...
        auto_width_megamenu();
		//Product Quick View
		if($('.btn-quick-view').length>0){
			$('.btn-quick-view').fancybox();
		}
		//Product Quick View
            ...
            var slider = $('#bxslider-home4').bxSlider({
                ...
                onSliderLoad:function(currentIndex){
                    $('#bxslider-home4 li').find('.caption').each(function(i){
                        $(this).fadeIn(400).addClass('animated fadeInRight').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
                ...
                onSlideBefore:function(slideElement, oldIndex, newIndex){
                    ...
                    slideElement.find('.caption').each(function(){                    
                       $(this).fadeOut(400).removeClass('animated fadeInRight'); 
                    });                
                },
...
setInterval(function(){
    $(document).find(".ts .owl-next").trigger("click");
}, 5000)

setInterval(function(){
    $(document).find(".bi .owl-next").trigger("click");
}, 3000)

s = 0;
setInterval(function(){
    s++
    $(document).find(".dt li a:eq("+s+")").trigger("click");
    if(s == 2)
    {
        s = -1;
    }
}, 15000)
$(document).on("click",".dt li a",function()
{
    $(".bt").text($(this).data("tit"));
})