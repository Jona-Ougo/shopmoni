...
$lang['my_account_page_title'] = 'Welcome {name}';
$lang['downloads_remaining'] = '{quantity} downloads left';
...
$lang['search_title'] = 'Search Results: {term}';
$lang['amount'] = 'Amount';
...
$lang['option_error'] = 'The following options are required:';
...
$lang['remove'] = 'Remove';
$lang['coupon'] = 'Coupon';
$lang['coupon_label'] = 'Have a coupon code?';
$lang['gift_card_label'] = 'Have a gift card code?';
...
$lang['error_no_payment_method'] = 'There is no payment method available.';
...
$lang['choose_shipping_method'] = 'Choose a Shipping Method';
$lang['no_shipping_needed'] = 'Your order does not require shipping.';
$lang['shipping_method_is_no_longer_valid'] = 'The requested shipping method is no longer valid';
...
$lang['gift_card_beginning_amount'] = 'Choose Gift Card Amount';
$lang['gift_card_to_email'] = 'To Email';
$lang['gift_card_from'] = 'From';
$lang['gift_card_personal_message'] = 'Personal Message';
$lang['gift_card_excerpt'] = 'Gift Card for a friend<br/>To: %s';
...
$lang['registration_awaiting_activation'] = 'Thanks for registering! Your account will be activated pending review. We have sent you a confirmation email.';
...
$lang['error_shipping_address'] = 'You must provide a shipping address.';
$lang['error_billing_address'] = 'You must provide a billing address.';

$lang['delete_address_confirmation'] = 'Are you sure you want to delete this address?';
$lang['message_address_deleted'] = 'The requested address was removed from your account.';
...
$lang['item_added_to_cart'] = 'This item was successfully added to your cart!';
$lang['item_already_added'] = 'This item is already in your cart!';
$lang['cart_updated'] = 'Your shopping cart has been updated';
...
$lang['coupon_code_no_longer_valid'] = 'The coupon "{coupon_code}" is no longer valid.';
$lang['whole_order_coupon_not_combinable'] = 'Whole order coupons cannot be combined with other coupons.';
$lang['gift_card_balance_applied'] = 'The gift card has been added.';
$lang['gift_card_zero_balance'] = 'Sorry, but the gift card you entered has a zero balance.';
$lang['gift_card_not_exist'] = 'The gift card code you entered does not exist.';
$lang['gift_card_already_applied'] = 'Your gift card is already applied';
$lang['error_updating_cart'] = 'There was an error updating the cart!';
$lang['gift_card_amount_applied'] = 'Amount applied: ';
$lang['gift_card_amount_remaining'] = 'Amount remaining: ';
$lang['not_enough_stock'] = 'The quantity requested for the "%s" product could not be added. We only have %d item(s) in stock.';
$lang['not_enough_stock_quantity'] = 'We only have {quantity} item(s) in stock.';
$lang['some_items_are_out_of_stock'] = 'Some items in your cart are out of stock.';
$lang['this_item_is_out_of_stock'] = 'This item is out of stock.';
$lang['remove_item'] = 'Are you sure you want to remove this item from your cart?';
$lang['banner_orders'] = 'Advert Orders';
$lang['banner_orders_not_found'] = "Sorry, there are no banner orders";
