 ...
 * @category    ZeusProducts
 * @author      Olaiya Segun
 * @link        https://twitter.com/massivebrains00
 */

class ZeusProducts extends Zeus {
    ...
    {        
        ...
        $config['base_url'] = site_url('zeus/products/'.$rows.'/'.$order_by.'/'.$sort_order.'/'.$code.'/');
    ...
    public function form($id = false, $duplicate = false)
    {
        ...
        */
        ...
        if (\CI::form_validation()->run() == FALSE){
            $this->view('products/product_form', $data);
        }else{
            \CI::load()->helper('text');
            ...
            $save['year']                   = \CI::input()->post('year');
            $save['location']               = strtolower(\CI::input()->post('location'));
            ...
            // save product
            // 0 Is set for customer id in the last parameter of the save() method below to show the it is the zeus who created this product.
            $product_id = \CI::Products()->save($save, $options, $categories, 0);
    ...
    public function product_image_form()
    {
        ...
        $data['error']  = false;
        $this->partial('products/iframe/product_image_uploader', $data);
    }
    ...
    public function product_image_upload()
    {
        ...
        //$config['min_width']        = config_item('full_image_width');
        //$config['min_height']       = config_item('full_image_height');
        //$config['max_width']        = config_item('full_image_width');
        //$config['max_height']       = config_item('full_image_height');
        ...
        if ( \CI::upload()->do_upload())
        {
            ...
            $config['width']            = config_item('medium_image_width');
            $config['height']           = config_item('medium_image_height');
            ...
            $config['maintain_ratio']   = TRUE;
            $config['width']            = config_item('small_image_width');
            $config['height']           = config_item('small_image_height');
            \CI::image_lib()->initialize($config);
            \CI::image_lib()->resize();
            \CI::image_lib()->clear();
            ...
            $config['maintain_ratio']   = TRUE;
            $config['width']            = config_item('thumbnails_image_width');
            $config['height']           = config_item('thumbnails_image_height');
            \CI::image_lib()->initialize($config);
            \CI::image_lib()->resize();
            \CI::image_lib()->clear();
    ...
    public function CategoryChildren($id = 0, $product_id = 0)
    {
        $children               = \DB\DB::getFew('categories', ['id', 'name'], ['parent_id' => $id]);
        $product                = \CI::Products()->find($product_id, true);
        $product_categories     = [];
        ...
        echo $this->partial('products/category_children', [
            'children' => $children,
            'primary_category' => isset($product->primary_category) ? $product->primary_category : [], 
