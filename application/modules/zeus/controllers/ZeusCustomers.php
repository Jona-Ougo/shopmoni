 ...
 * @category ZeusCustomers
 * @author Clear Sky Designs
 * @link http://gocartdv.com
 */

class ZeusCustomers extends Zeus {
    ...
    { 
        ...
        $data['customers'] = \CI::Customers()->get_merchants(50, $page, $field, $by);
        
        \CI::load()->library('pagination');

        $config['base_url'] = site_url('/zeus/customers/index/'.$field.'/'.$by.'/');
    ...
    public function form($id = false)
    {
        ...
        {
            $this->view('customers/customer_form', $data);
        }
        else
        {
            $save['id'] = $id;
    ...
    public function addresses($id = false)
    {
        ...
        $this->view('customers/customer_addresses', $data);
    }
    ...
    public function groups()
    {
        ...
        $this->view('customers/customer_groups', $data);
    }
    ...
    public function groupForm($id=0)
    {
        ...
        if (\CI::form_validation()->run() == FALSE)
        {
            $this->view('customers/customer_group_form', $data);
        }
        else
        {
            if($id)
            ...
            redirect('zeus/customers/groups');
        }
    }
    ...
    public function addressList($customer_id)
    {
        ...
        $this->view('customers/address_list', $data);
    }
    ...
    public function addressForm($customer_id, $id = false)
    {
        ...
        if (\CI::form_validation()->run() == FALSE)
        {
            $this->view('customers/customer_address_form', $data);
        }
        else
        {
            ...
            \CI::Customers()->save_address($a['field_data']);
            \CI::session()->set_flashdata('message', lang('message_saved_address'));
            
            redirect('zeus/customers/addresses/'.$customer_id);
        }
    }
    ...
    public function loginAudit()
    {
        ...
        $data['audit']          = \CI::Customers()->loginAudit();
        $data['page_title']     = 'Customers Login Audit';
        
        $this->view('customers/customers_login_audit', $data);
    }
