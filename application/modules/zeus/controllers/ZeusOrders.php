...
class ZeusOrders extends Zeus {
    ...
    public function index($sort_by='order_number',$sort_order='desc', $code=0, $page=0, $rows=100)
    {
        ...
        if(\CI::input()->post('submit') == 'export')
        {
            ...
            {
                //Do something here.
                $o->items = \CI::Orders()->getItems($o->id, 0, true);
            }
        ...
        $config['base_url'] = site_url('zeus/orders/index/'.$sort_by.'/'.$sort_order.'/'.$code.'/');
    ...
    public function packing_slip($order_number)
    {
        ...
        $this->partial('orders/packing_slip', $data);
    }
