...
function save_sortable()
{
    ...
    $.ajax({
        url:'<?php echo site_url('zeus/banners/organize');?>',
        type:'POST',
        data:serial
    });
}
...
<div class="text-right">
    <a class="btn btn-primary" href="<?php echo site_url('zeus/banners/banner_form/'.$banner_collection_id); ?>"><i class="icon-plus"></i> <?php echo lang('add_new_banner');?></a>
    <a class="btn btn-primary" href="<?php echo site_url('zeus/banners/'); ?>"><?php echo lang('banner_collections');?></a>
</div>
...
<table class="table table-striped">
    ...
    foreach ($banners as $banner):
        ...
        <tr id="banners-<?php echo $banner->banner_id;?>"<?php echo $disabled;?>>
            ...
            <td class="text-right">
                <div class="btn-group">
                    <a class="btn btn-default" href="<?php echo site_url('zeus/banners/banner_form/'.$banner_collection_id.'/'.$banner->banner_id);?>"><i class="icon-pencil"></i></a>
                    <a class="btn btn-danger" href="<?php echo  site_url('zeus/banners/delete_banner/'.$banner->banner_id);?>" onclick="return areyousure();"><i class="icon-times "></i></a>
                </div>
            </td>
        </tr>
    <?php endforeach; ?>
