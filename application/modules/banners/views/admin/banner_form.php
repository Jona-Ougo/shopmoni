...
<?php echo form_open_multipart('zeus/banners/banner_form/'.$banner_collection_id.'/'.$banner_id); ?>
    ...
    <div class="form-group">
        ...
        <?=form_dropdown('admin_status',['review'=> 'Review', 'approved' => 'Approved', 'rejected' => 'Rejected'], assign_value('advert_credit_id',$admin_status), 'class="form-control"'); ?>
    </div>
