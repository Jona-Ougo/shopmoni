...
class AdminSettings extends Zeus {
    ...
    public function __construct()
    {
        ...
        /*
        * Remeber gocart admin was built to access the views/admin folder ?
        * And remember we have given a merchant the /admin routes?
        * But some routes and modules dont concern the merchants. they are for zeus.
        * One of them is the settings module. and that is why i made it extend Zeus. (check this extends Zeus above)
        * And if it extends Zeus it would be looking of views in the views/zeus/ path. (check application/core/Zeus.php)
        * So this $this->viewFolder new property helps me to point this controller to the views/admin folder
        * got it?
        */
