...
<a class="btn btn-primary" style="float:right;"href="<?php echo site_url('zeus/customers/address_form/'.$customer->id);?>"><i class="icon-plus"></i> <?php echo lang('add_new_address');?></a>
<table class="table">
    <thead>
        <tr>
...
<?php foreach ($addresses as $address):?>
        <tr>
            ...
            <td class="text-right">
                <div class="btn-group">
                    <a class="btn btn-default" href="<?php echo site_url('zeus/customers/address_form/'.$customer->id.'/'.$address['id']);?>"><i class="icon-pencil"></i></a>
                    <a class="btn btn-danger" href="<?php echo site_url('zeus/customers/delete_address/'.$customer->id.'/'.$address['id']);?>" onclick="return areyousure();"><i class="icon-times"></i></a>
                </div>
            </td>
        </tr>
<?php endforeach; ?>
