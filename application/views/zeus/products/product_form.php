...
<?=form_open('zeus/products/form/'.$id ); ?>
<div class="row">
    <div class="col-md-9">
        <div class="tabbable">
        ...
        <div class="tab-content">
                    ...
                    <div class="row" style="padding-top:10px;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?=form_dropdown('fixed_quantity', [1 => lang('yes'), 0 => lang('no')], assign_value('fixed_quantity',$fixed_quantity), 'class="form-control"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
            ...
            <?php include('product_form_categories.php') ?>
        ...
        <div class="tab-pane" id="product_related">
            ...
            <div class="alert alert-info">
                Related products show up on the sidebar when this current product is viewed. Search for your existing products that are related to this current product and add them.
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <input class="form-control" type="text" id="product_search" placeholder="Type name of your existing product" />
                    </div>
                    ...
                    <div class="form-group">
                        <select class="form-control" id="product_list" size="5"></select>
                    </div>
                    <button type="button" onclick="add_related_product();return false;" class="btn btn-primary" title="Add Related Product"><?=lang('add_related_product');?></button>
                </div>
        ...
        <div class="tab-pane" id="product_photos">
            <iframe id="iframe_uploader" src="<?=site_url('zeus/products/product_image_form');?>" style="height:75px; width:100%; border:0px;"></iframe>
...
<div class="col-md-3">
    ...
    <div class="form-group">
        ...
        <?=form_input(['name'=>'sku', 'value'=>assign_value('sku', $sku), 'class'=>'form-control']);?>
    </div>
