...
{
    $('body').spin();
    $.post('<?php echo site_url('zeus/reports/best_sellers');?>',{start:$('#best_sellers_start_alt').val(), end:$('#best_sellers_end_alt').val()}, function(data){
...
{
    $('body').spin();
    $.post('<?php echo site_url('zeus/reports/sales');?>',{year:$('#sales_year').val()}, function(data){
