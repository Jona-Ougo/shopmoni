...
function theme_file($path = '', $type = '', $alt = '', $class = ''){
    $location =  base_url('themes/'.config_item('theme').'/assets/'.$path);
    if($type == 'css'){
        return '<link href="'.$location.'" type="text/css" rel="stylesheet" media="all"/>';
    }else if($type == 'js'){
...
function theme_image($path = '', $class='', $alt = '')
{
     $location =  base_url('themes/'.config_item('theme').'/assets/'.$path);
     return '<img src="'.$location.'" alt="'.$alt.'" class="'.$class.'">'; 
}
